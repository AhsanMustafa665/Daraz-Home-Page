...
const You = (props) => {
  ...
  return (
    <div>
      <div
        style={{ lineHeight: "1" }}
        className=" bg-white border border-white hover:border hover:border-gray-200 rounded-sm hover:drop-shadow-sm w-[190px] h-[330px]"
      >
        <div className="px-2">
          <a href="#">
            <img src={img} alt="" />
          ...
          <div>
            <a href="#">
              <p className="text-[13px] text-gray-700 font-[500] uppercase pt-6">
                {name.slice(0, 47) + "..."}
              </p>
            </a>
